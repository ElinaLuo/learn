...
var script = {
  ...
  computed: {
    classes: function classes() {
      return [
        uiBase.prefixCls("btn"),
        uiBase.prefixCls(this.getBtnStyle),
        this.size ? uiBase.prefixCls(("size_" + (this.size))) : uiBase.prefixCls('size_m') ];
    },
    type2classes: function type2classes() {
      var obj;

      return [
        uiBase.prefixCls('btn', 'type2'),
        uiBase.prefixCls('btn', 'type2', ("sub" + (this.subType))),
        ( obj = {}, obj[uiBase.prefixCls('bold')] = this.bold, obj ) ];
    },
    type3classes: function type3classes() {
      var obj;

      return [
        uiBase.prefixCls('btn', 'type3'),
        uiBase.prefixCls('btn', 'type3', ("sub" + (this.subType))),
        ( obj = {}, obj[uiBase.prefixCls('bold')] = this.bold, obj ) ];
    },
