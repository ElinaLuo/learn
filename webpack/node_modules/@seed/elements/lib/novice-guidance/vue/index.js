...
var script = {
  ...
  computed: {
    classes: function classes() {
      return {
        wrap: uiBase.prefixCls('novice-guidance', 'wrap'),
        arrow: [
          uiBase.prefixCls('novice-guidance', 'arrow'),
          this.flipArrow && uiBase.prefixCls('novice-guidance', 'arrow', 'flipped') ],
        close: uiBase.prefixCls('novice-guidance', 'close'),
        outer: [
          uiBase.prefixCls('novice-guidance'),
          uiBase.prefixCls(
            'novice-guidance',
            this.type === 'circle' ? 'circle' : 'rectangle'
          ),
          this.visible && uiBase.prefixCls('novice-guidance', 'fadein') ],
        text: uiBase.prefixCls('novice-guidance', 'text'),
      };
    },
  },
  methods: {
