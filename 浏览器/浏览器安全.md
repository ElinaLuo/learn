...
5.cookie 设置http-only：https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Guides/CSP
...
6.Cookie开启httpOnly，攻击js就无法访问document.cookie
7.主动检测和发现：自动扫描工具寻找潜在的 XSS 漏洞
